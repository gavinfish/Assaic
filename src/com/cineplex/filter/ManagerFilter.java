...
/**
 * grant authorization of resource of manager
* @author Andy 1993sj19993@gmail.com  
* @date 2015年4月16日 下午4:06:53  
*
 */
public class ManagerFilter implements Filter {
	...
	// private static String MANAGER_INDEX =
	// "/cineplex/manager/manager-index.jsp";
	...
	public void doFilter(ServletRequest req, ServletResponse resp,
		...
		} else if ("waiter".equals(accountType)) {
			response.sendRedirect(WAITER_INDEX);
		} else {
